      ...
      <div className="w-64 bg-[#014c6c] border-b text-white p-4 flex flex-col justify-between">
        <div>
          ...
          <nav className="space-y-2">
            ...
            <Link href="/admin/forms/contact-form" className="block py-2 px-4 rounded text-white hover:bg-gray-700">
              Contact Form
            </Link>
            <Link href="/admin/forms/home-form" className="block py-2 px-4 text-white rounded hover:bg-gray-700">
              Home Form
            </Link>
          </nav>
        </div>
