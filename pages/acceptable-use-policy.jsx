...
import { AcceptableUsePolicySchema } from '../lib/data/schema'
...
export default function AcceptableUsePolicy({ contactData, error }) {
  ...
  return (
    <div>
      ...
      <title>Acceptable Use Policy</title>
        ...
        <link rel="canonical" href="https://spamcloud.in/acceptable-use-policy" />
	...
	<meta property="og:url" content="https://spamcloud.in/acceptable-use-policy" />
	<meta property="og:site_name" content="Sixth Star Technologies" />
  <script
                  type="application/ld+json"
                  dangerouslySetInnerHTML={{ __html: JSON.stringify(AcceptableUsePolicySchema) }}
                />
      </Head>
